...
st.title("📄 OJS to PubMed XML Converter")
st.markdown("Convert Open Journal Systems XML files to PubMed format")
...
with st.sidebar.expander("❓ Help & Instructions"):
    st.markdown("""
    **How to use:**
    1. Enter your OJS API credentials
...
# Footer
st.markdown("---")
st.markdown("*OJS to PubMed XML Converter - Built with Streamlit*")